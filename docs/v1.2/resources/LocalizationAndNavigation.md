...
Message types for navigation goals and robot localization. A [`Goal`](#goal) specifies a mission target; [`Pose`](#pose) is reported in [Robot Status](RobotStatus.md#getrobotstatus).
